...
def run_proteome_annotation(args):
	...
	annotator.curate_annotations(precomputed_hmm_cutoffs=os.path.join(args.hmmdb, "cutoffs.csv"))  # "/g/scb2/zeller/karcher/CAZY_project_v2/results/CV_HMMs_optimal_cutoffs_all_v3.csv")
	# breakpoint()
	annotator.annotations_filtered.to_csv(args.output_file)  # "cazy_annotations.csv")